...
#region //// MAIN ////
	...
	globalvar VERSION_STRING; VERSION_STRING = "1.21.9.205"; // Display on menu panel, workshop thumbnail  ALSO for automated build name.
	...
	globalvar BUILD_NUMBER; BUILD_NUMBER   = 1_21_09_2.05;
